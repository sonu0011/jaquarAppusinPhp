...
public class NewArrivalsActivity extends AppCompatActivity {
    ...
    public static final String TAG ="NewArrivals";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout =findViewById(R.id.newarrivalscoor);
        list =new ArrayList<>();
        ...
        progressDialog =new ProgressDialog(NewArrivalsActivity.this);
        recyclerView =findViewById(R.id.commonrecycleview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(NewArrivalsActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.logout_menu){
            new Constant().ShowLogoutDialog(NewArrivalsActivity.this);
        }
    ...
    protected void onStart() {
        ...
        StringRequest stringRequest = new StringRequest(StringRequest.Method.POST,
                    ...
                    public void onResponse(String response) {
                        if (response != null) {
                            ...
                            try {
                                ...
                                adapter = new ProductsAdapter(NewArrivalsActivity.this,list,coordinatorLayout);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("newArrivals", "set");
                return map;
            }
        };
        MySingleton.getInstance(NewArrivalsActivity.this).addToRequestQuee(stringRequest);
    }
}